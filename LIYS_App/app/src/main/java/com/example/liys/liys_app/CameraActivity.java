    ...
    public void onPreviewFrame(final byte[] bytes, final Camera camera) {
        ...
        try {
            ...
            if (rgbBytes == null) {
                ...
                onPreviewSizeChosen(new Size(previewSize.width, previewSize.height), 270);//back camera degree = 90, front = 270
            }
...
//                    "yuvBytes[0] len: " + yuvBytes[0].length +
//                    "\nyuvBytes[1] len: " + yuvBytes[1].length +
//                    "\nyuvBytes[2] len: " + yuvBytes[2].length +
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            requestPermissions(new String[]{PERMISSION_CAMERA, PERMISSION_STORAGE
                    , PERMISSION_INTERNET, PERMISSION_RECORD_AUDIO}, PERMISSIONS_REQUEST);
        }
    }
    ...
    private String chooseCamera() {
        ...
        try {
            for (final String cameraId : manager.getCameraIdList()) {
                ...
                LOGGER.e("support Camera API lv2?: %s", useCamera2API);
                //TODO: reopen camera2 API
                useCamera2API = false;
                LOGGER.e("use Camera API lv2?: %s", useCamera2API);
                return cameraId;
            }
